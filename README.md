...
## Install on Mobile (App Shortcut)
1. Open the website in **Google Chrome** (Android) or **Safari** (iOS).
2. Tap the **"Add Shortcut"** button in the header (or browser menu > **"Add to Home screen"** / **"Install App"**).
3. The app will now appear on your phone home screen just like a regular native app.

## Host on GitHub Pages
1. Push this repository to GitHub.
2. Go to **Settings** > **Pages**.
3. Under **Branch**, select `main` and root `/`.
4. Click **Save** and open your live URL!

## Credits & Author
- **Developer:** Abdul Awal Ibn Rafi (ID: 261071044)
- **GitHub:** [@0xrafiKaji](https://github.com/0xrafiKaji)
- Department of CSE and CSIT, Shanto-Mariam University of Creative Technology
